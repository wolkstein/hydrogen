...
//	std::list<QString> m_musicCategories;
	...
	m_sOutMidiPortName = QString("None");
		...
		if ( !rootNode.isNull() ) {
			...
			if ( audioEngineNode.isNull() ) {
				...
				if ( midiDriverNode.isNull() ) {
					...
					m_sOutMidiPortName = LocalFileMng::readXmlString( midiDriverNode, "out_port_name", "None" );
...
void Preferences::savePreferences()
{
	...
	QDomNode audioEngineNode = doc.createElement( "audio_engine" );
	{
		...
		QDomNode midiDriverNode = doc.createElement( "midi_driver" );
		{
			...
			LocalFileMng::writeXmlString( midiDriverNode, "out_port_name", m_sOutMidiPortName );
